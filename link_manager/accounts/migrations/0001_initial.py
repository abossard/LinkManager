...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Nonce'
        db.create_table('accounts_nonce', (
        ...
        db.send_create_signal('accounts', ['Nonce'])

        # Adding model 'Association'
        db.create_table('accounts_association', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('accounts', ['Association'])

        # Adding model 'OpenIDUser'
        db.create_table('accounts_openiduser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('accounts', ['OpenIDUser'])


    def backwards(self, orm):
        
        # Deleting model 'Nonce'
        db.delete_table('accounts_nonce')

        # Deleting model 'Association'
        db.delete_table('accounts_association')

        # Deleting model 'OpenIDUser'
        db.delete_table('accounts_openiduser')
